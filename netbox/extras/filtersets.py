...
class CustomFieldFilterSet(ChangeLoggedModelFilterSet):
    ...
    class Meta:
        model = CustomField
        fields = (
            'id', 'object_types', 'name', 'label', 'group_name', 'required', 'search_weight', 'filter_logic',
            'ui_visible', 'ui_editable', 'weight', 'is_cloneable', 'description', 'validation_minimum',
...
class ExportTemplateFilterSet(ChangeLoggedModelFilterSet):
    ...
    class Meta:
        ...
        fields = (
            'id', 'object_types', 'name', 'description', 'mime_type', 'file_extension', 'as_attachment',
